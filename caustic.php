...
?>
    <div class="stats" v-for="segment in info.segments" v-if="segment.metadata.name === 'Caustic'">
            ...
            <h3>Nombre de dégats en saison 1 :</h3>
            <p>{{segment.stats.seasonDamage.displayValue}} {{segment.stats.seasonDamage.displayName}}</p>
